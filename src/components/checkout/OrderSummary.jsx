...
export default function OrderSummary({
  ...
  return (
    <div className="bg-white border border-gray-300 rounded-lg p-6 max-h-[calc(100vh-20rem)] flex flex-col">
      <h2 className="text-lg font-semibold mb-4 text-gray-900 shrink-0">
        Ringkasan Pesanan
      </h2>

      {/* Cart Items */}
      <div
        className="space-y-3 mb-4 overflow-y-auto shrink-0"
      ...
      <div className="border-t border-gray-200 pt-4 space-y-2 text-sm shrink-0">
        {/* Subtotal */}
      ...
      {/* Total */}
      <div className="border-t border-gray-300 mt-4 pt-4 shrink-0">

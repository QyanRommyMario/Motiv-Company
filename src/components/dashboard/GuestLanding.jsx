    ...
    <LazyMotion features={domAnimation}>
      <div className="min-h-screen bg-white">
        ...
        <main id="main-content">
          ...
          >
            <div
              className="absolute inset-0 bg-gradient-to-b from-black/70 via-transparent to-black/70 z-0"
              aria-hidden="true"
            />
            ...
            <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
              ...
              <m.div
                ...
                className="absolute bottom-10 left-1/2 -translate-x-1/2 !text-white/60 text-[10px] uppercase tracking-[0.3em]"
                aria-hidden="true"
              >
                {t("scroll")}
              </m.div>
        ...
        <footer
          className="bg-[#0A0A0A] py-16 text-center border-t border-white/5"
          role="contentinfo"
        >
